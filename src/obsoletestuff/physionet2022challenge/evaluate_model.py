...
def evaluate_model(label_folder, output_folder):
    ...
    cm = compute_confusion_matrix(murmur_labels, murmur_binary_outputs)
    print(cm)
    cm = compute_confusion_matrix(murmur_labels, outcome_binary_outputs)
    print(cm)
    cm = compute_confusion_matrix(outcome_labels, outcome_binary_outputs)
    print(cm)
